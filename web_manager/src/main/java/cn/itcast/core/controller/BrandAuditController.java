...
public class BrandAuditController {
    ...
    public List<Brand> findAll() {
        List<Brand> list = brandAuditService.findAll();
        return list;
    }
...
//    }
     ...
     * @return
     */
    @RequestMapping("/savetosql")
    public Result add(Integer[] ids) {
        try {
            brandAuditService.add(ids);
    ...
    public Brand findOne(Long id) {
        Brand one = brandAuditService.findOne(id);
        return one;
    }
    ...
    public Result update(@RequestBody Brand brand) {
        try {
            brandAuditService.update(brand);
    ...
    public PageResult search(@RequestBody(required = false) Brand brand, Integer page, Integer rows) {
        PageResult pageResult = brandAuditService.findPage(brand, page, rows);
        return pageResult;
    }
    ...
    public List<Map> selectOptionList() {
        List<Map> maps = brandAuditService.selectOptionList();
        return maps;
    }
}
